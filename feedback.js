const { BitProficiency, MemSize, ReqFlag, ReqType, getMemSizes, getOperands, PartialAccess, ReqOperand } = require("./logic");
...
module.exports = { assess_code_notes, assess_achievement, assess_leaderboard, assess_rich_presence, assess_set };