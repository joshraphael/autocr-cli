const { BitProficiency, MemSize, ReqFlag, ReqAddrType, ReqType, getMemSizes, getOperands, PartialAccess, ReqOperand, Requirement, PAUSERESET, ConditionFormatter } = require("./logic");
